...
import { PaginatedResponse, SilverZakat } from '@/types/model';
...
export default function ZakatSilverList({
    query,
    sumAllAmount,
    zakats,
}: {
    query?: { search?: string };
    sumAllAmount: number;
    zakats: PaginatedResponse<SilverZakat>;
}) {
    ...
    const _list = () => {
        list.get(route('zakat-silver.list'), {
            preserveState: true,
            preserveScroll: true,
            replace: true,
        });
